...
export const studentCopy = {
  ...
  songChoice: {
    ...
    preview: (song: string) => `Preview ${song}`,
    pausePreview: (song: string) => `Pause preview of ${song}`,
    previewUnavailable: "This song preview is not available yet.",
  ...
  mechanics: {
    ...
    chooseEarlierHit: "Unlock requirement (optional)",
