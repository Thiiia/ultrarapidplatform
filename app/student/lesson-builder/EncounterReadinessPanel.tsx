...
export function EncounterReadinessPanel({
  ...
  return (
    <aside aria-label="Encounter readiness" style={{ position: "sticky", bottom: 12, zIndex: 10, display: "grid", gap: 8, padding: 12, borderRadius: 12, border: `1px solid ${readiness.ready ? "#CFFF04" : "#FFCB6B"}`, background: "#0A1222F5", color: "#FFFFFF", boxShadow: "0 12px 30px rgba(0,0,0,.3)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center" }}>
        <strong>Lesson check</strong>
        <span style={{ color: readiness.ready ? "#CFFF04" : "#FFCB6B", fontSize: 11, fontWeight: 900 }}>
