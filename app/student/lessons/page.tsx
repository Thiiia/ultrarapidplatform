...
import MyLessonsTab from "@/public/header_icons/my_lessons_tab_pressed.svg";
...
{utilityTabs.map((tab) => {
  ...
  return (
    ...
    >
      ...
      <DashboardSection title="My Lessons">
        <div
          style={{
            display: "grid",
        ...
        >
          <PlaceholderCard
            ...
            description="View all lessons currently assigned to you across subjects."
          />
          <PlaceholderCard
            title="In Progress"
            description="Resume lessons you have already started and continue where you left off."
          />
          <PlaceholderCard
            title="Completed"
            description="Review lessons you have finished and revisit previous work."
          />
        </div>
      </DashboardSection>
    </div>
