...
Shader "UI/TranslucentImage-Paraform"
{
    Properties
    {
        ...
        _EdgeGlint1Color("Edge Glint 1 Color", Color) = (.25, .25, .25, 1)
        _EdgeGlint2Color("Edge Glint 2 Color", Color) = (.1, .1, .1, 1)
        [HideInInspector] _EdgeGlint1Strength("Edge Glint 1 Strength (Deprecated)", Range(0, 1)) = .25
        [HideInInspector] _EdgeGlint2Strength("Edge Glint 2 Strength (Deprecated)", Range(0, 1)) = .1
