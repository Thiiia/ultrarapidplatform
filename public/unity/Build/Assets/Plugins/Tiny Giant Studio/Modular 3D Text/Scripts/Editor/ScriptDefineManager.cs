...
namespace MText
{
    internal static class ScriptDefineManager
    {
        ...
        private static void AddScriptDefine()
        {
            ...
            NamedBuildTarget namedBuildTarget = NamedBuildTarget.FromBuildTargetGroup(currentTarget);

            if (currentTarget == BuildTargetGroup.Unknown)
                return;

            string scriptDefinesString = PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget).Trim();
            ...
            PlayerSettings.SetScriptingDefineSymbols(namedBuildTarget, scriptDefinesString);
        }
    }
}
#endif
